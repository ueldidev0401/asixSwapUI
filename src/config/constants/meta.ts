...
export const DEFAULT_META: PageMeta = {
  title: 'AsixplusDAO',
  description:
    'The most popular AMM on BSC by user count! Earn ASIXMUSIC through yield farming or win it in the Lottery, then stake it in Syrup Pools to earn more tokens! Initial Farm Offerings (new token launch model pioneered by AsixplusDAO), NFTs, and more, on a platform you can trust.',
  image: '',
}
